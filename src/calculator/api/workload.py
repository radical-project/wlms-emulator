...
class Workload(object):
    ...
    def __init__(self, num_tasks=0, ops_dist='uniform', dist_mean=None, dist_var=None):
        ...
        if not num_tasks or not ops_dist or not dist_mean or not dist_var:
            raise CalcMissingError(obj=self._uid,
                                   missing_attribute='num_tasks, ops_dist, dist_mean, or dist_var')
